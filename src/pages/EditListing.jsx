...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if (images.length > 6) {
      setLoading(false)
      toast.error('More than 6 Images')
      return
    }
    let geolocation = {}
    let location
    ...
    setLoading(false)
    toast.success('Credentials Edited')
  ...
  return (
    <main class='max-w-md px-2 mx-auto'>
      <h1 class='text-3xl text-center mt-6 font-bold'>Edit Credentials</h1>
        ...
        {!geolocationEnabled && (
          <div className='flex space-x-6 mb-6'>
            <div className=''>
              ...
              <input
                class='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:bg-white focus:text-gray-700 focus;border-slate-700 text-center'
                type='number'
                id='latitude'
                value={latitude}
                onChange={onChange}
